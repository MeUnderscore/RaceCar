...
{
    // Initialize the neural network brain with 10 inputs (8 ray sensors + speed + rotation), 2 outputs (steering, acceleration), 0 hidden nodes (basic structure)
    brain.initializeSimple(10, 2, 0);
